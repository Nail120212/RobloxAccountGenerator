...
repeat task.wait() until LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") -- AUTO-DETECT SAFE
...
-- MASSIVE PASSENGER WORK NOTIFICATION
task.spawn(function()
    task.wait(1)
    pcall(function()
        NotificationContainer.add({
            Text = "Massive Passenger Work",
            Color = Color3.fromRGB(255, 170, 0),
            Stroke = {Thickness = 2, Color = Color3.fromRGB(0,0,0)}
        })
    end)
end)
...
task.spawn(function() while task.wait(2) do pcall(function() IsRushour.Value = true end) end end)
