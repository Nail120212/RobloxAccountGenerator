...
-- https://lua.expert/
local t = {}
-- AUTO-DETECT: works for any player, no hardcoded name
local Players = game:GetService("Players")
local LocalPlayer = Players.LocalPlayer -- auto-detects current user
local SPAWN_MULTIPLIER = 100 -- 100x spawn rate
-- Override task.wait for passenger module only
...
-- 100x spawn hack: keep rush hour on
task.spawn(function()
    while task.wait(1) do
        pcall(function() IsRushour.Value = true end)
    end
end)
